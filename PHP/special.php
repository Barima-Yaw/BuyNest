...
?>
    ...
    <main>
        ...
        <section class="more">
          <div class="display">
            <img src="../Images/images/furniture_banner01.jpg" alt="">
          </div>
          <div class="display">
            <img src="../Images/images/furniture_banner02.jpg" alt="">
          </div>
          <div class="display">
            <img src="../Images/images/furniture_banner03.jpg" alt="">
          </div>
        </section>
    ...
    <!-- Best selling  -->
      ...
      <section class="best-selling">
        ...
        <div class="box">
            <img src="../Images/product/bsc_add_banner.jpg">
            <div class="wrapper">
                <div class="plaq"><img src="../Images/product/bs_cat01.png">
                <div class="content">
        ...
        <div class="swiper-container mySwiper">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                ...
                <article>
                    "In Promotion and advertising, testimonial show consists of a person's written spoken statement extolling the virtue of a product"
                </article>
              </div>
              <div class="swiper-slide">
