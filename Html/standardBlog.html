    ...
    <main>
      ...
      <section class="blog-main">
        ...
        <div class="main">
            <div class="big">
                <div class="imgBox">
                    <img src="../Images/blog/s_blog_thumb01.jpg" alt="">
                    <a href="#">Beauty</a>
                </div>
                <div class="text">
                    <h2>REASONS TO WAX INSTEAD OF SHAVING</h2>
                    <p>Cramond Leopard & Pythong Print Anorak Jacket In Beige but also the leap into electronic typesetting, remaining Lorem Ipsum is simply dummy text of the printing and typesetting industrorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley</p>
                    <div class="interact">
                        <a href="../Html/blogDetails.html">Read More...</a>
                        <div class="stamp">
                            <span><i class="far fa-user"></i> By Fabrizio Rico</span> /
                            <span><i class="far fa-calendar-alt"></i> August 20, 2021</span> /
                            <span><i class="far fa-comments"></i> 0 Comment</span>
                        </div>
                    </div>
                </div>
                <div class="imgBox">
                    <img src="../Images/blog/s_blog_thumb02.jpg" alt="">
                    <a href="#">Accessible</a>
                </div>
                <div class="text">
                  <h2>WITH HASSLE FREE AND SECURE PAYMENTS</h2>
                    <p>Cramond Leopard & Pythong Print Anorak Jacket In Beige but also the leap into electronic typesetting, remaining Lorem Ipsum is simply dummy text of the printing and typesetting industrorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley</p>
                    <div class="interact">
                        <a href="../Html/blogDetails.html">Read More...</a>
                        <div class="stamp">
                ...
                <div class="imgBox">
                    <img src="../Images/blog/s_blog_thumb03.jpg" alt="">
                    <a href="#">Professional</a>
                </div>
                <div class="text">
                  <h2>ONLINE PAYMENT ACCOUNTS SMARTER HERE</h2>
                    <p>Cramond Leopard & Pythong Print Anorak Jacket In Beige but also the leap into electronic typesetting, remaining Lorem Ipsum is simply dummy text of the printing and typesetting industrorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley</p>
                    <div class="interact">
                        <a href="../Html/blogDetails.html">Read More...</a>
                        <div class="stamp">
